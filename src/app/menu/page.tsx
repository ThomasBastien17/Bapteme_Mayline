  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="min-h-screen flex flex-col items-center justify-center gap-8 bg-red-50 p-6">
        <h1 className={`text-5xl font-bold text-[#d6a8a7] mb-4 mt-4 ${corinthia.className}`}>Menu du Baptême</h1>
        <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg p-6 border-4 border-[#d6a8a7] bg-opacity-90 text-center font-serif">
          <div className="space-y-2 text-lg text-gray-700">
            ...
            <p>
              <span className={`text-4xl font-bold text-[#d6a8a7] mb-4 ${corinthia.className}`}>Apéritif frais</span> <br />
            ...
            <p>
              <span className={`text-4xl font-bold text-[#d6a8a7] mb-4 ${corinthia.className}`}>Plat principal</span> <br />
            ...
            <p>
              <span className={`text-4xl font-bold text-[#d6a8a7] mb-4 ${corinthia.className}`}>Dessert</span>  <br />
